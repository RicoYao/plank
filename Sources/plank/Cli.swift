...
func handleGenerateCommand(withArguments arguments: [String]) {
    ...
    let nullabilityAnnotationType: String? = flags[.javaNullabilityAnnotationType]
    let extends: String? = flags[.javaExtends]
    let implements: String? = flags[.javaImplements]
